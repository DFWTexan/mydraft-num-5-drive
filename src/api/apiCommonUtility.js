...
//       response = await fetch(`${BLACKBIRD_AUCTION_BASE}/${url}`, {headers, method, body});
//     } else if (params && params.base_url === 'SIMULCAST') {
// 			response = await fetch(`${BLACKBIRD_SIMULCAST_BASE}/${url}`, {headers, method, body});
// 		}
//     else {
//       response = await fetch(`${BLACKBIRD_API_BASE}/${url}`, {headers, method, body});
//     }
//     return response;
//   }
